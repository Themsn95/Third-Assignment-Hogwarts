...
//        while (true) {
//            System.out.println("Press 1 if you are student\nPress 2 if you are teacher\nPress 3 if you are assistance\nPress 4 to exit");
//
//            int a = input.nextInt();
//            if (a != 1 && a != 2 && a != 3 && a != 4) {
...
public class Main {
    public static void main(String[] args) {
        Assistant assistant = new Assistant("matin", "matinsn95");
        ...
        while (true) {
            ...
            if (input.equals("logOut")) {
                ...
                while (true) {
                    ...
                    input = in.next();
                    boolean find = false;
                    for (int i = 0; i < Hogwarts.Assistant.size(); i++) {
                        find |= Hogwarts.Assistant.get(i).getUsername().equals(input);
                    }
                    if (find) {
                ...
                Hogwarts.Assistant.add(newAssistant);
            }
...
//                    System.out.println("PassWOrd : " + Hogwarts.students.get(num - Hogwarts.students.size() - 1).());
                    ...
                    for (int i = 0; i < Hogwarts.teachers.get(num - Hogwarts.students.size() - 1).courses.size(); i++) {
                        ...
                        for (int j = 0; j < course.getStudent().size(); j++) {
                            System.out.print(course.getStudent().get(j) + " - ");
                        }
                    }
                    System.out.print("\n");
            ...
            if (input.equals("logOut")) {
                ...
                if (input.equals("changePass")) {
                    ...
                    for (int i = 0; i < Hogwarts.courses.size(); i++) {
                        Course course = Hogwarts.courses.get(i);
                        for (int j = 0; j < Course.getStudent().size(); j++) {
                            if (Course.getStudent().get(j).equals(lastUserName))
                                course.getStudent().get(j).equals(input);
                        }
        ...
        while (true) {
            ...
            //teacher
                ...
                if (input.equals("signup")) {
                    while (true) {
                        ...
                        if (find) {
                            ...
                            System.out.print("enter passWord: ");
                            String pass = in.next();
                            Teacher newTeacher = new Teacher(input, "matinsn95");
                ...
                while (true) {
                    ...
                    for (int i = 0; i < Hogwarts.Assistant.size(); i++) {
                        if (Hogwarts.Assistant.get(i).getUsername().equals(input)) {
                            assistant = Hogwarts.Assistant.get(i);
                        }
                        find |= Hogwarts.Assistant.get(i).getUsername().equals(input);
                    }
                    if (!find) {
